...
class AknNabasaScreen extends StatefulWidget {
  @override
  _AknNabasaScreen createState() => _AknNabasaScreen();
}

class _AknNabasaScreen extends State<AknNabasaScreen> {
  bool _loading = false;
  bool _isLoading = false;
  List<bool> inputs = new List<bool>();
  final String apiUrl =
      'https://www.nabasa.co.id/api_remon_v1/tes.php/getUserAknNabasa';
  ...
  Future submitAkses(String userid, String val) async {
    ...
    //server login api
    var url =
        'https://www.nabasa.co.id/api_remon_v1/tes.php/submitAksesAknNabasa';
