...
class NabasaScreen extends StatefulWidget {
  @override
  _NabasaScreen createState() => _NabasaScreen();
}

class _NabasaScreen extends State<NabasaScreen> {
  bool _loading = false;
  bool _isLoading = false;
  List<bool> inputs = new List<bool>();
  final String apiUrl =
      'https://www.nabasa.co.id/api_remon_v1/tes.php/getUserNabasa';
  ...
  Future submitAkses(String userid, String val) async {
    ...
    //server login api
    var url = 'https://www.nabasa.co.id/api_remon_v1/tes.php/submitAksesNabasa';
