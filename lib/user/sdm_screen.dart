...
class SdmScreen extends StatefulWidget {
  @override
  _SdmScreen createState() => _SdmScreen();
}

class _SdmScreen extends State<SdmScreen> {
  bool _loading = false;
  bool _isLoading = false;
  List<bool> inputs = new List<bool>();
  final String apiUrl =
      'https://www.nabasa.co.id/api_remon_v1/tes.php/getUserSdm';
  ...
  Future submitAkses(String userid, String val) async {
    ...
    //server login api
    var url = 'https://www.nabasa.co.id/api_remon_v1/tes.php/submitAkses';
