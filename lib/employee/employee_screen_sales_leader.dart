...
class EmployeeSalesLeaderScreen extends StatefulWidget {
  @override
  _EmployeeSalesLeaderScreen createState() => _EmployeeSalesLeaderScreen();
}

class _EmployeeSalesLeaderScreen extends State<EmployeeSalesLeaderScreen> {
  bool _isLoading = false;
  final String apiUrl =
      'https://www.nabasa.co.id/api_remon_v1/tes.php/getEmployeeSalesLeader';
  ...
  void fetchUsers() async {
    ...
    if (result.statusCode == 200) {
      setState(() {
        _users = json.decode(result.body)['Daftar_Employee_Sales_Leader'];
        _isLoading = false;
      });
    }
  }
