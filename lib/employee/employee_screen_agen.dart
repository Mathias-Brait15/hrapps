...
class EmployeeAgenScreen extends StatefulWidget {
  @override
  _EmployeeAgenScreen createState() => _EmployeeAgenScreen();
}

class _EmployeeAgenScreen extends State<EmployeeAgenScreen> {
  bool _isLoading = false;
  final String apiUrl =
      'https://www.nabasa.co.id/api_remon_v1/tes.php/getEmployee';
  ...
  void fetchUsers() async {
    ...
    if (result.statusCode == 200) {
      setState(() {
        _users = json.decode(result.body)['Daftar_Employee'];
        _isLoading = false;
      });
    }
  }
