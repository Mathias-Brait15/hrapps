...
class EmployeeRepresentativeScreen extends StatefulWidget {
  @override
  _EmployeeRepresentativeScreen createState() =>
      _EmployeeRepresentativeScreen();
}

class _EmployeeRepresentativeScreen
    extends State<EmployeeRepresentativeScreen> {
  bool _isLoading = false;
  final String apiUrl =
      'https://www.nabasa.co.id/api_remon_v1/tes.php/getEmployeeRepresentative';
  ...
  void fetchUsers() async {
    ...
    if (result.statusCode == 200) {
      setState(() {
        _users = json.decode(result.body)['Daftar_EmployeeRepresentative'];
        _isLoading = false;
      });
    }
  }
